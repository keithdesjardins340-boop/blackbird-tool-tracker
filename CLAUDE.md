...
**Read [`FABLE.md`](FABLE.md) first — it's the working brief** (what this app is,
how Keith wants it worked on, the hard rules, the traps that have actually bitten
people here, and how to verify anything given no local Node). It applies to every
